  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_dropdowns: "flex items-center px-10 gap-6",
        ...
        day_selected:
          "bg-main text-main hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
