...
export const EmptyScreen = () => {
  ...
  return (
    <div className="relative h-full flex-1">
      <div className="relative flex h-full w-full flex-col items-center justify-center overflow-auto bg-transparent bg-grid-black/[0.05] dark:bg-grid-white/[0.05]">
        ...
        <p className="relative z-20 -translate-y-16 bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text text-center text-4xl font-bold text-transparent sm:text-7xl">
        ...
        <div className="grid grid-cols-2 gap-2 px-4 sm:px-0">
          {cardMessages.map((card, index) => (
            ...
            >
              <div className="text-sm font-semibold text-main dark:text-main-foreground">
                {card.heading}
              </div>
